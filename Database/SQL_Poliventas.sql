...
BEGIN
    SELECT P.idProvider, P.IdProducto, P.Nombre, P.PrecioUnitario, P.Categoria, P.Descripcion, P.CantidadDisponible, P.TiempoMaxEntrega, P.CalificacionPromedioProducto, P.NroBusquedas, P.FechaIngreso, V.CalificacionPromedioVendedor
...
BEGIN
	SELECT CVp.idCompraVentaProducto, P.idProducto, P.idProvider, P.CantidadDisponible, P.PrecioUnitario, P.Nombre, P.PrecioUnitario, P.Categoria, P.Descripcion, CVp.Cantidad ,P.TiempoMaxEntrega, P.CalificacionPromedioProducto, P.NroBusquedas, P.FechaIngreso
    FROM Productos P, ComprasVentasProductos CVp
    WHERE idCompraVenta=CVp.idCompraVentaProducto ;
END
//
DELIMITER ;
...
BEGIN
	SELECT P.idProvider, P.idProducto, P.Nombre, P.PrecioUnitario, P.Categoria, P.Descripcion, P.CantidadDisponible, P.TiempoMaxEntrega, P.CalificacionPromedioProducto, P.NroBusquedas, P.FechaIngreso, V.CalificacionPromedioVendedor
    FROM Productos P, ComprasVentasProductos CVp, Vendedores V
...
DELIMITER //
CREATE PROCEDURE readPagoOperacion(
	IN idCompraVenta INT
	)
BEGIN
	SELECT O.idOperacion, O.idPerson1, O.idPerson2, O.FechaHora, O.Tipo
    FROM Operaciones O
    WHERE idCompraVenta=O.idOperacion ;
END
//
DELIMITER ;
...
DELIMITER //
CREATE PROCEDURE obtenerCalificacionPromedioProducto(IN idProd INT)
BEGIN
SELECT P.CalificacionPromedioProducto
    FROM Productos P
...
DELIMITER //
CREATE PROCEDURE createOperacion(IN idvendedor INT, IN idcomprador INT, IN Fecha DATE, IN tipo VARCHAR(45))
BEGIN
insert into Operaciones( idPerson1, idPerson2,FechaHora, Tipo)
values(idvendedor, idcomprador, Fecha, tipo);
...
DELIMITER //
CREATE PROCEDURE createCompraVenta(IN idoperacion INT, IN monto DOUBLE, estado VARCHAR(45))
BEGIN
insert into ComprasVentas( idCompraVenta, idTrading, MontoTotal, Estado)
values(idoperacion, idoperacion, monto, estado);
...
DELIMITER //
CREATE PROCEDURE createCompraVentaProducto(IN idcompra INT, IN idproducto INT, IN cantidad INT)
BEGIN
...
DELIMITER //
CREATE PROCEDURE createPago(IN idoperacion INT, IN idpurchase INT,IN valor DOUBLE, tipo VARCHAR(45))
BEGIN
insert into Pagos( idPurchase, ValorAbonado, FormaPago)
values(idpurchase, valor, tipo);
...
DELIMITER //
CREATE PROCEDURE createPagoEfectivo(IN idpurchase INT,IN valor DOUBLE, tipo VARCHAR(45))
BEGIN
insert into PagosEfectivo( idPayCash, ValorEntrega, Cambio)
values(idpurchase, valor, tipo);
...
insert into Operaciones( idPerson1, idPerson2,FechaHora, Tipo)
values(1, 1, DATE("2019-01-15 09:34:21"), 'PagoElectronico'),
		  (1, 1, DATE("2019-01-15 10:34:21"), 'PagoEfectivo');
