...
public class ProductoDAOImpl implements IProductoDAO {
    ...
    public static ObservableList<Producto> BusquedaSencillaN = FXCollections.observableArrayList();
    public static ObservableList<Producto> MasBuscado = FXCollections.observableArrayList();
    public static ObservableList<Producto> MisProductos = FXCollections.observableArrayList();
    public static ObservableList<Producto> BusquedaSencillaD = FXCollections.observableArrayList();
    ...
    public List<Producto> readMasBuscados() throws Exception {
        ...
        for(Producto elemento:articulos){
            MasBuscado.add(elemento);
        }
        rs1.close();
        cs1.close();
        return articulos;
    ...
    public List<Producto> busquedaSencillaNombre(String nombreProducto) throws Exception {
        ...
        for( Producto elemento:articulos){
            BusquedaSencillaN.add(elemento);
        }System.out.println(BusquedaSencillaN.toString());
        rs1.close();
        cs1.close();
        return articulos;
    ...
    public List<Producto> busquedaSencillaDescripcion(String descripcionProducto) throws Exception {
        ...
        while (rs1.next()) {
            ...
            BusquedaSencillaD.add(elemento);
        }
        rs1.close();
        cs1.close();
        return articulos;
    ...
    public int obtenerCalificacionPromedioProducto(int idProducto) throws Exception {
        ...
        if (rs2.next()) {
            return rs2.getInt("CalificacionPromedioProducto");
        } else {
